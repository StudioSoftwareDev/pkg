...
var exec = exports.exec = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(argv2) {
        ...
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            argv = (0, _minimist2.default)(argv2, {
              ...
              string: ['_', 'c', 'config', 'o', 'options', 'output', 'outdir', 'out-dir', 'out-path', 't', 'target', 'targets'],
          ...
          case 209:
            ...
            _context3.next = 217;
            return (0, _walker2.default)(marker, entrypoint, addition);
          ...
          case 217:
            ...
            backpack = (0, _packer2.default)({ records: records, entrypoint: entrypoint, bytecode: bytecode });
          ...
          case 247:
            ...
            _context3.next = 250;
            return (0, _producer2.default)({ backpack: backpack, bakes: bakes, slash: slash, target: _target4 });
          ...
          case 258:
            _context3.prev = 258;
            _context3.t6 = _context3['catch'](228);
    ...
    }, _callee3, this, [[93, 97, 101, 109], [102,, 104, 108], [113, 128, 132, 140], [133,, 135, 139], [144, 161, 165, 173], [166,, 168, 172], [177, 197, 201, 209], [202,, 204, 208], [228, 258, 262, 270], [263,, 265, 269]]);
  }));
